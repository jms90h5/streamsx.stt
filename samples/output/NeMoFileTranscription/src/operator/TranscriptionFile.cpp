// CAbUB7OIkEALWsBKf22cPUfWJ54I3jY2N0sh0Ja37PpQOI8GEFKbvCHHoFex3MoTW9SmvTtSkrQjk6IiggIrA1
...
#define MY_BASE_OPERATOR TranscriptionFile_Base
#define MY_OPERATOR TranscriptionFile$OP
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("TranscriptionFile",&initer));
    return true;
}
