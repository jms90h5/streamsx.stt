...
#ifndef SPL_OPER_INSTANCE_ANALYSIS_H_
#define SPL_OPER_INSTANCE_ANALYSIS_H_
...
public:
    ...
    typedef SPL::Bs5pNmw71y7PkapZ9lqBSwKrkbWCriwV7k_0ArlSoM1rLHrNgAEBvk5Tpn6YTnjdDdoEcBr6nreFdzTolVZ3wtD9 OPort0Type;
    ...
    SPL::rstring state$fullTranscription;
    SPL::int32 state$chunkCount;
    SPL::timestamp state$processStart;
...
#undef MY_OPERATOR
#endif // SPL_OPER_INSTANCE_ANALYSIS_H_
