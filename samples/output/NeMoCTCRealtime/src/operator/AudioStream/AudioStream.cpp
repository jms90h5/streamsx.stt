// ssCmUxN6bRjTua1dsMrVcAj5DJD_0pgWsJRaFm6j0gSAxZBI8cHmnWOWeP4gfBpJyX0gUqz_0jiu1UMgd2KlKfBW
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    state$samplesPerBlock = SPL::uint32(::SPL::spl_cast<SPL::uint32, SPL::int32 >::cast(SPL::int32(SPL::int32(::SPL::spl_cast<SPL::int32, SPL::rstring >::cast(lit$7) * lit$6) / lit$5)) / state$bytesPerSample);
