// KeqIUGe6fznZfh5whpwN6yanz9yDxnklF9AR0HtkKKLb7PaaZdH4HHgA4kNNOYCNU7ll1NlOBteb_0QzC7_1jYB6
...
while(!getPE().getShutdownRequested()) {
    ...
    try {
            ...
            unsigned rSize;
            std::unique_ptr<char> data(new char[::SPL::spl_cast<SPL::uint32, SPL::int32 >::cast(SPL::int32(SPL::int32(::SPL::spl_cast<SPL::int32, SPL::rstring >::cast(lit$3) * lit$2) / lit$1))]);
            sbfs.getFixedCharSequence(data.get(), ::SPL::spl_cast<SPL::uint32, SPL::int32 >::cast(SPL::int32(SPL::int32(::SPL::spl_cast<SPL::int32, SPL::rstring >::cast(lit$3) * lit$2) / lit$1)), rSize);
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    param$blockSize$0 = ::SPL::spl_cast<SPL::uint32, SPL::int32 >::cast(SPL::int32(SPL::int32(::SPL::spl_cast<SPL::int32, SPL::rstring >::cast(lit$3) * lit$2) / lit$1));
    addParameterValue ("blockSize", SPL::ConstValueHandle(param$blockSize$0));
