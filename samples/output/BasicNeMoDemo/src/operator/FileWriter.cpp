// 4Ucl9p8wZUBKkq97THxTmQeKohOUtQUPsR_12LS71YGOOQdKdR5Q2X0OWsMI2xjo4ICADA_1TAmH1t4AMNZNlfB9
...
: MY_BASE_OPERATOR(),
  _shutdown(false),
  _pattern(((lit$1 + ::SPL::spl_cast<SPL::rstring, SPL::float64 >::cast(::SPL::Functions::Time::getTimestampInSecs())) + lit$0)),
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    param$file$0 = ((lit$1 + ::SPL::spl_cast<SPL::rstring, SPL::float64 >::cast(::SPL::Functions::Time::getTimestampInSecs())) + lit$0);
